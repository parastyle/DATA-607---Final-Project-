...
for(L in allImportantLinks[1:3]){
  url = paste0(L)
...
title = dataMissing(str_extract_all(as.character(title),'(?<=name">)[[:alpha:] ]*(?=<)'))
...
print(L)
observation = list(I(list(style)),title,I(list(colors)),I(list(materials)),original_price,sale,rating,'bloomingdales')
